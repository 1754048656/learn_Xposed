        ...
        XposedHelpers.findAndHookMethod("android.content.ContextWrapper", classLoader, "getApplicationContext", new XC_MethodHook() {
            ...
            protected void afterHookedMethod(MethodHookParam param) throws Throwable {
                ...
                if (context == null) {
                    ...
                    Log.i(TAG,"hooking...getApplicationContext");
                    try {
                        SharedPreferences sharedPreferences = MultiprocessSharedPreferences.getSharedPreferences(context, "test", Context.MODE_WORLD_WRITEABLE);
                        sharedPreferences.edit().putString("hello", "eeeeeeeeee").commit();
//                    String hello = sharedPreferences.getString("hello", "");
                        Log.i(TAG, "afterHookedMethod: put hello eeeeeeeeee");
                    }catch (Exception e) {
